...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">{{ __('lang.categories') }}</a></li>
        ...
        <div class="card">
            <div class="card-block">
                ...
                <div class="row show-details-row">
                    ...
                    <div class="col-sm-10">
                        {{ $category->translate($showLang)->categories_title }}
                    </div>
                </div>
{{-- 
                ...
                <div class="row show-details-row">
                    ...
                    <div class="col-sm-10">
                        {!! $category->translate($showLang)->categories_desc !!}
                    </div>
                </div> --}}
